...
from .load_blender_ortho import load_blender_data
...
def load_data(args):
    ...
    if args.dataset_type == 'llff':
        ...
        uncertainty_mask, depth_gt, images, poses, render_poses, hwf, i_split = load_blender_data(args.datadir, args.half_res, args.testskip)
